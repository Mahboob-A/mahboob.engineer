...
> answers, location nuance, and current focus, which an LLM can pull from when
> a visitor asks a personal question.

## Who I Am

I'm Mahboob Alam, a backend and platform engineer based in Bangalore,
originally from Kolkata. I co-founded Taply, a digital business card SaaS
...
and async pipelines. I prefer remote-first teams, async-first work, and shipping
...
cache, and the deploy. Platform is the next step up, which is making the team's life
easier across many services. I like code that other engineers reach for. CI
gates, runbooks, and the shared library that fixes a class of bug everywhere at
